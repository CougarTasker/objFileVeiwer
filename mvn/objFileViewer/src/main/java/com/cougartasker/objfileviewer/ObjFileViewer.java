...
public class ObjFileViewer extends JFrame implements ActionListener {
  private static final long serialVersionUID = 4283906618020208436L;
  private Cam view;
  ...
  ObjFileViewer() {
    ...
    instructions.setText("<html><p style=\"padding:0;margin:0;\">\n"
        + "this is a simple .obj 3d file viewer with smooth shading. to rotate the camera"
        + " use the wasd keys and to pan(move) the camera press the arrow keys.\n" + "</p></html>");
    add(instructions, c);
